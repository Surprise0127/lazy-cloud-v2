package com.lazy.c.security.config;
...
import com.lazy.c.security.filter.JwtAuthenticationFilter;
import com.lazy.c.security.handler.AccessDeniedHandlerImpl;
import com.lazy.c.security.handler.CertifiedFailedHandlerImpl;
...
public class SecurityAutoConfiguration {
    ...
    public IUserPermissionService userPermissionService() {
        return (loginUser, claims) -> {
            Object jti = claims.get("");
        };
    }
