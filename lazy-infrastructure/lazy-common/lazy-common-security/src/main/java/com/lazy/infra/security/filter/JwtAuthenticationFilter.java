package com.lazy.infra.security.filter;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        // 6. 加载用户权限（通过领域服务 → ISysUserRepository 依赖倒置）
        java.util.Collection<String> permissions = userPermissionService.loadPermissions(uniqueIdentifier);
